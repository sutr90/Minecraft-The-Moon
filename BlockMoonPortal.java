...
public class BlockMoonPortal extends Block {
	...
	public void setBlockBoundsBasedOnState(IBlockAccess var1, int var2,
			int var3, int var4) {
		float var5;
		float var6;
	...
	public boolean tryToCreatePortal(World var1, int var2, int var3, int var4) {
		...
		byte var5 = 0;
		byte var6 = 0;
		if (var1.getBlockId(var2 - 1, var3, var4) == cheese
				|| var1.getBlockId(var2 + 1, var3, var4) == cheese) {
			var5 = 1;
		}

		if (var1.getBlockId(var2, var3, var4 - 1) == cheese
				|| var1.getBlockId(var2, var3, var4 + 1) == cheese) {
			var6 = 1;
		}
	...
	public void onNeighborBlockChange(World var1, int var2, int var3, int var4,
		...
		if (var1.getBlockId(var2, var8 - 1, var4) != cheese) {
			var1.setBlockWithNotify(var2, var3, var4, 0);
		} else {
			int var9;
			for (var9 = 1; var9 < 4
					&& var1.getBlockId(var2, var8 + var9, var4) == this.blockID; ++var9) {
				;
			}

			if (var9 == 3 && var1.getBlockId(var2, var8 + var9, var4) == cheese) {
				...
				if (var10 && var11) {
					var1.setBlockWithNotify(var2, var3, var4, 0);
				} else if ((var1.getBlockId(var2 + var6, var3, var4 + var7) != cheese || var1
						.getBlockId(var2 - var6, var3, var4 - var7) != this.blockID)
						&& (var1.getBlockId(var2 - var6, var3, var4 - var7) != cheese || var1
								.getBlockId(var2 + var6, var3, var4 + var7) != this.blockID)) {
					var1.setBlockWithNotify(var2, var3, var4, 0);
				}
			} else {
	...
	public boolean shouldSideBeRendered(IBlockAccess var1, int var2, int var3,
		...
		if (var1.getBlockId(var2, var3, var4) == this.blockID) {
			...
			return var10 && var5 == 4 ? true : (var10 && var5 == 5 ? true
					: (var11 && var5 == 2 ? true : var11 && var5 == 3));
		}
	}
	...
	public void randomDisplayTick(World var1, int var2, int var3, int var4,
		...
		if (var5.nextInt(100) == 0) {
			var1.playSoundEffect((double) var2 + 0.5D, (double) var3 + 0.5D,
					(double) var4 + 0.5D, "portal.portal", 1.0F,
